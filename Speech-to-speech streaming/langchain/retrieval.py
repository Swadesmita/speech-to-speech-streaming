...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\coding\python\INFOSYS\infosys-446716-31b25ed01ab2.json"
...
if __name__ == "__main__":
    ...
    vectorstore = PineconeVectorStore(index_name="infosys", embedding=embeddings)
