...
def replace_audio_in_video(video_path, audio_path, output_path):
    ...
    ffmpeg.output(video_stream.video, audio_stream.audio, output_path, vcodec="copy", acodec="aac").run()
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return jsonify({
                ...
                "download_link": url_for('uploaded_file', filename=f"{unique_id}_translated_{language}.mp4")})
